...
reflection__CLASS_BEGIN_inherit( MyStructReflection, public, MyStructOriginal )
  ...
  reflection__CLASS_STATIC_inspect(   "integer",          MyStructOriginal, public, m_int     )
  reflection__CLASS_STATIC_inspect(   "float-point",      MyStructOriginal, public, m_float   )
  reflection__CLASS_STATIC_inspect(   "standard-string",  MyStructOriginal, public, m_string  )
