...
reflection__CLASS_BEGIN_inherit( MyStructReflection, public, MyStructOriginal )
  ...
  reflection__CLASS_STATIC_inspect(   "integer",          MyStructOriginal, m_int     )
  reflection__CLASS_STATIC_inspect(   "float-point",      MyStructOriginal, m_float   )
  reflection__CLASS_STATIC_inspect(   "standard-string",  MyStructOriginal, m_string  )
