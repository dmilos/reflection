...
reflection__CLASS_BEGIN_inherit( MyStructReflection, public, MyStructOriginal )
  ...
  reflection__CLASS_FIELD_mutate(   "integer",          MyStructOriginal, m_int     )
  reflection__CLASS_FIELD_mutate(   "float-point",      MyStructOriginal, m_float   )
  reflection__CLASS_FIELD_mutate(   "standard-string",  MyStructOriginal, m_string  )
