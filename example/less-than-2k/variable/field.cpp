...
reflection__CLASS_BEGIN_inherit( MyStructReflection, public, MyStructOriginal )
  ...
  reflection__CLASS_FIELD_variable(   "integer",          MyStructOriginal, public, m_int     )
  reflection__CLASS_FIELD_variable(   "float-point",      MyStructOriginal, public, m_float   )
  reflection__CLASS_FIELD_variable(   "standard-string",  MyStructOriginal, public, m_string  )
