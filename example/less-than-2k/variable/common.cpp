...
reflection__CLASS_BEGIN_inherit( MyStructReflection, public, MyStructOriginal )
  ...
  reflection__CLASS_STATIC_variable(   "integer",          MyStructOriginal, m_int     )
  reflection__CLASS_STATIC_variable(   "float-point",      MyStructOriginal, m_float   )
  reflection__CLASS_STATIC_variable(   "standard-string",  MyStructOriginal, m_string  )
