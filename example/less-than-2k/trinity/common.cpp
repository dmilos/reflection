...
reflection__CLASS_BEGIN_inherit( MyStructReflection, public, MyStructOriginal )
  ...
  reflection__CLASS_STATIC_trinity(   "integer",          MyStructOriginal, public, m_int     )
  reflection__CLASS_STATIC_trinity(   "float-point",      MyStructOriginal, public, m_float   )
  reflection__CLASS_STATIC_trinity(   "standard-string",  MyStructOriginal, public, m_string  )
