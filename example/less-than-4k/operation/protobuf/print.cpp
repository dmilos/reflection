...
int main( int argc, char *argv[] )
 {
  ...
  { 
   ...
   auto protobuf_context = protobuf_type::context();
   protobuf_type protobuf( observe, protobuf_context );

    //::reflection::operation::transfer::protobuf::register_class<MyFirstClassOriginal, MyFirstClassReflectionView>( observe, protobuf_context );
    //::reflection::operation::transfer::protobuf::register_class<MyBaseClass, MyBaseClasssReflectionView>( observe, protobuf_context ); 
    //::reflection::operation::transfer::protobuf::register_enum<MyMainClass::Enumerator>( observe, protobuf_context ); 
    //::reflection::operation::transfer::protobuf::register_vector<int>( observe, protobuf_context );
  }
  observe.view( std::cout, r ); // protobufize
