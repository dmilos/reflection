...
int main( int argc, char *argv[] )
 {
  ...
  { 
   ...
   protobuf_type protobuf( observe, protobuf_context );
    ...
    //protobuf_type::register_class<MyFirstClassOriginal, MyFirstClassReflectionView>( observe, protobuf_context );
    //protobuf_type::register_class<MyBaseClass, MyBaseClasssReflectionView>( observe, protobuf_context ); 
    //protobuf_type::register_enum<MyMainClass::Enumerator>( observe, protobuf_context ); 
    //protobuf_type::register_container< std::<int> >( observe, protobuf_context );
  }
