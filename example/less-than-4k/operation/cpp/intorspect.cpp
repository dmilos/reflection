...
int main( int argc, char *argv[] )
 {
  ...
  {
   typedef ::reflection::operation::transfer::cpp::introspect_struct<std::ostream> cpp_type;
   auto cpp_context = cpp_type::context();
   cpp_type cpp( observe, cpp_context );

    //cpp_type::register_class<MyFirstClassOriginal, MyFirstClassReflectionView>( observe, xml_context );
    //cpp_type::register_class<MyBaseClass, MyBaseClasssReflectionView>( observe, xml_context );
    //cpp_type::register_enum<MyMainClass::Enumerator>( observe, xml_context );
    //cpp_type::register_vector<int>( observe, xml_context );
  }
