...
int main( int argc, char *argv[] )
 {
  ...
  ::reflection::property::function::execute<int, int&, std::string const&, float &>( r.get( "static_int_int_string_float" ), i, "asdasd", f, true );
  std::cout << f << ", "<< i << std::endl;

  ::reflection::property::function::execute<void, int&, std::string  const&, float &>( r.get( "static_void_int_string_float" ), i, "asdasd", f, true );
  std::cout << f << ", "<< i << std::endl;
