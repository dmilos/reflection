...
reflection__CLASS_BEGIN_inherit( MyClassReflection, public, MyClassOriginal )
  ...
  reflection__CLASS_FUNCTION_member( "member_void_int", MyClassOriginal, public, member_void_int )
  reflection__CLASS_FUNCTION_member( "member_int_int" , MyClassOriginal, public, member_int_int )
...
int main( int argc, char *argv[] )
 {
  ...
  std::cout << i << std::endl;
  ::reflection::property::function::execute<int, int& >( r.get( "member_int_int" ), i );
  std::cout << i << std::endl;

  ::reflection::property::function::execute<void, int& >( r.get( "member_void_int" ), i );
  std::cout << i << std::endl;
