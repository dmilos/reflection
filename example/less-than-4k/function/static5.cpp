...
class MyClassOriginal
 {
  ...
  public:
    static void static_void_int_string_float_bool( int &i , std::string const& s, float & f, bool b )
     {
      std::cout << __FUNCTION__ << std::endl;
      std::cout << i << std::endl;
      i = 12345;
...
reflection__CLASS_BEGIN_inherit( MyClassReflection, public, MyClassOriginal )
    ...
    reflection__CLASS_FUNCTION_static( "static_void_int_string_float_bool", MyClassOriginal, public,  static_void_int_string_float_bool )
  //reflection__CLASS_FUNCTION_static( "static_int_int_string_float_bool",  MyClassOriginal, private, static_int_int_string_float_bool  )
...
int main( int argc, char *argv[] )
 {
  ...
  // private ::reflection::property::function::execute<int, int&, std::string const&, float &, bool>( r.get( "static_int_int_string_float_bool" ), i, "asdasd", f, true );
  // private std::cout << f << ", "<< i << std::endl;

  ::reflection::property::function::execute<void, int&, std::string  const&, float &, bool>( r.get( "static_void_int_string_float_bool" ), i, "asdasd", f, true );
  ...
  ::reflection::content::function::execute<std::string>( r.get("static_void_int_string_float_bool"), argument );
  std::cout << p1.present() << std::endl;

  //argument[0]= &r.get("int-point");
  //p1.disclose() = 4567;
  //std::cout << p1.present() << std::endl;
  //::reflection::content::function::execute<std::string>( r.get("static_int_int_string_float_bool"), argument );
  //std::cout << p1.present() << std::endl;
