...
int main( int argc, char *argv[] )
 {
  ...
  // ::reflection::property::function::execute<int, int&, std::string const&, float &, bool>( r.get( "static_int_int" ), i, "asdasd", f, true );
  // std::cout << f << ", "<< i << std::endl;

  ::reflection::property::function::execute<void, int& >( r.get( "static_void_int" ), i );
  std::cout << f << ", "<< i << std::endl;
