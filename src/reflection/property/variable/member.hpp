     ...
     namespace variable
      {
       ...
       template
        ...
        >
       inline
       typename ::reflection::property::variable::member_struct<original_name,image_name,class_name,storage_name>::typedef_type
       member
        (
        ...
        {
         typedef ::reflection::property::variable::member_struct<original_name,image_name,class_name,storage_name> member_type;
