     ...
     namespace variable
      {
        ...
        struct  common_struct
         {
          ...
          typedef ::reflection::property::inspect::common_struct<data_name,image_type,class_type>     inspect_type;
       ...
       template
        ...
        >
        inline
        typename ::reflection::property::variable::common_struct<data_name,original_name,image_name,class_name>::typedef_type
        common
         (
           data_name      *carrier_param
         )
         {
          typedef ::reflection::property::variable::common_struct<data_name,original_name,image_name,class_name> common_type;
