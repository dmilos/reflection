        ...
        struct  member_struct
         {
          ...
          typedef ::reflection::property::mutate::member_struct<model_name,class_name,storage_type,report_name> mutate_type;

          typedef typename  direct_type::extractor_type   extractor_type;
          typedef typename mutate_type::assigner_class   assigner_class;

          typedef ::reflection::property::exposed::base_class <original_name, model_name, storage_name, extractor_type, assigner_class, report_name>      typedef_type;
          ...
          static typedef_type make( storage_type const& carrier_param, traitor_type const& traitor_param, writter_type const& writter_param )
           {
            return typedef_type( carrier_param, extractor_type( traitor_param ), assigner_class( writter_param ) );
           }
         };
