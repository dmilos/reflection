#ifndef reflection_property_valid_base
#define reflection_property_valid_base
    ...
    namespace valid
     {
      ...
      template
       ...
       >
       class basic_class
        : virtual public ::reflection::property::valid::pure_class< report_name >
        , virtual public ::reflection::property::_internal::proxy_class< storage_name>
        {
         ...
         public:
           report_type valid( void )const
            {
             return this->carrier_type::storage().test();
            }
