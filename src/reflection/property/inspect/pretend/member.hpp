...
// ::reflection::property::inspect::pretend::member_class<pretend_name,converter_type,storage_name,reader_name>
// ::reflection::property::inspect::pretend::member<pretend_name,converter_name,image_name,class_name,storage_name>( storage_name, image_name, converter_name )
