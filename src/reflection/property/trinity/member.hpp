     ...
     namespace trinity
      {
        ...
        struct  member_struct
         {
          public:
            ...
            typedef ::reflection::property::inspect::member_struct<image_type,class_type,storage_type>           inspect_type;
       ...
       template
        ...
        >
       inline
       typename ::reflection::property::trinity::member_struct<original_name,model_name,image_name,class_name,storage_name,report_name>::typedef_type
       member
        (
        ...
        {
         typedef ::reflection::property::trinity::member_struct<original_name,model_name,image_name,class_name,storage_name,report_name> member_type;
