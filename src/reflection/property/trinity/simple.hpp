       ...
       struct simple_struct
        ...
        , public ::reflection::property::inspect::simple_struct< data_name,image_name >
        {
         public:
           ...
           typedef ::reflection::property::mutate::simple_struct< data_type,model_name,report_name >      mutate_type;
           ...
           typedef ::reflection::property::trinity::base_class<data_type, original_type, model_name,image_type,storage_type,extractor_type,assigner_type,retriever_type,report_name> typedef_type;
