     ...
     namespace trinity
      {
        ...
        struct  field_struct
         {
          ...
          typedef data_name           data_type;
            ...
            typedef ::reflection::property::direct::field_struct<data_type,original_type,class_type,storage_type>          direct_type;
            typedef ::reflection::property::inspect::field_struct<data_type,image_type,class_type,storage_type>           inspect_type;
            typedef ::reflection::property::mutate::field_struct<data_type,model_type,class_type,storage_type,report_type> mutate_type;
            ...
            typedef ::reflection::property::trinity::base_class <original_type,model_name, image_name, storage_name, extractor_type, assigner_type, retriever_type, report_name>      typedef_type;
       ...
       template
        ...
        >
       inline
       typename ::reflection::property::trinity::field_struct<data_name,original_name,model_name,image_name,class_name,storage_name,report_name>::typedef_type
       field
        (
        ...
        {
         typedef ::reflection::property::trinity::field_struct<data_name,original_name,model_name,image_name,class_name,storage_name,report_name> field_type;
