...
#define reflection__CLASS_ENUM_begin(  enumerator_string_name, enumerator_symbolic_name ) \
 { \
  ...
  auto                         enumeration_instance = ::memory::pointer::make( enumeration_type( #enumerator_symbolic_name ) );  \
...
#define reflection__CLASS_ENUM_MEMBER_value(  enumerant_string_name, class_symbolic_name, enumerant_symbolic_name ) \
 { \
  enumeration_instance->push( enumerant_string_name, class_symbolic_name::enumerant_symbolic_name ); \
 }

#define reflection__CLASS_ENUM_end( enumerator_symbolic_name ) \
 }

#define reflection__CLASS_ENUM_MEMBER_begin( enumerator_string_name, class_symbolic_name, enumerator_symbolic_name )\
 { \
  typedef /*decltype( enumerator_string_name)*/ std::string identifier_type;     \
...
#define reflection__CLASS_ENUM_MEMBER_end( enumerator_symbolic_name, class_symbolic_name ) \
 } 
