#ifndef reflection_operation_transfer_ini
#define reflection_operation_transfer_ini
    ...
    namespace transfer
     {
      ...
      template
       ...
       >
       struct ini_struct //!< Windows ini file
        {
         private:
         ...
         public:
           ...
           typedef ::reflection::operation::transfer::ini_struct<output_name,key_name,identifier_name, report_name, container_name> this_type;
         ...
         public:
           ini_struct( observe_type & observe_param )
            {
