#ifndef reflection_operation_transfer_yaml
#define reflection_operation_transfer_yaml
       ...
       struct yaml_struct
        {
         ...
         public:
           ...
           typedef ::reflection::operation::transfer::yaml_struct<output_name,key_name,identifier_name, report_name, container_name> this_type;
         ...
         public:
           yaml_struct( observe_type & observe_param )
            {
         ...
         private:
           ...
           static report_type conclusio  ( internalPtr_type indent,  output_type & output_param, key_type const& key_param, property_qualified_reference_type property_param )
            {
             output_param << std::endl;
