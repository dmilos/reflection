#ifndef reflection_operation_transfer_python_serialize
#define reflection_operation_transfer_python_serialize

// ::reflection::operation::transfer::python::serialize_class<output_name,key_name,type_name>
