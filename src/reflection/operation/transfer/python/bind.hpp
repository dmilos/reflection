#ifndef reflection_operation_transfer_python_bind
#define reflection_operation_transfer_python_bind
         ...
         struct bind_struct
          {
           ...
           public:
             typedef ::reflection::operation::transfer::python::bind_struct<output_name,key_name,identifier_name, report_name, container_name> this_type;
           ...
           public:
             explicit bind_struct( observe_type & observe_param, contextPtr_type context_param = this_type::context() )
              {
