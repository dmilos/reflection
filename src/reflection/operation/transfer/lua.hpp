       ...
       struct lua_struct
        {
         public:
           ...
           typedef ::reflection::operation::transfer::lua_struct<output_name,key_name,identifier_name, report_name, container_name> this_type;
         ...
         public:
           lua_struct( observe_type & observe_param )
            {
            }
