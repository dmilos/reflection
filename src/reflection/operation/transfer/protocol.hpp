       ...
       struct protocol_struct
        {
         public:
           ...
           typedef typename ::reflection::operation::transfer::action_struct< output_type, key_type, qualificator_name, report_type > action_type;

           typedef typename  action_type::function_type function_type;

           typedef typename container_name< type_type, function_type >::container_type menu_type;
           ...
           static bool               exists( menu_type const& container, type_type const& key )
            {
             return ::reflection::type::container::exists< type_type, function_type >( container, key );
            }
           ...
           static function_type const& find( menu_type const& container, type_type const& key )
            {
             ...
             return ::reflection::type::container::data< type_type, function_type >( container, iterator );
            }

           static function_type      & find( menu_type      & container, type_type const& key )
            {
             auto iterator = ::reflection::type::container::find< type_type, function_type  >( container, key );
             if( container().end() == iterator )
              {
              ...
              return ::reflection::type::container::data< type_type, function_type  >( container, key );
            }
