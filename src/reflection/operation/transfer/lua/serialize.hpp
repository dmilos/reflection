#ifndef reflection_operation_transfer_lua_serialize
#define reflection_operation_transfer_lua_serialize

// ::reflection::operation::transfer::lua::serialize_class<output_name,key_name,type_name>
