#ifndef reflection_operation_transfer_ini_introspect
#define reflection_operation_transfer_ini_introspect
      ...
      namespace ini
       {
        ...
        template
         ...
         >
         struct introspect_struct //!< Print flat. No complex members, no base classes
          {
           private:
           ...
           public:
             ...
             typedef ::reflection::operation::transfer::ini::introspect_struct<output_name,key_name,identifier_name, report_name, container_name> this_type;
