    ...
    namespace trinity
     {
      ...
      template
       ...
       struct simple_struct
        : public ::reflection::content::direct::simple_struct< original_name >
        ...
        , public ::reflection::content::inspect::simple_struct< data_name,image_name >
        {
         public:
           ...
           typedef ::reflection::content::direct::simple_struct< data_name, original_name >          direct_type;
           ...
           typedef ::reflection::content::trinity::basic_class<data_name,original_name,image_name,model_name,storage_type,extractor_type, assigner_type, retriever_type, report_name > typedef_type;
      ...
      template
       ...
       >
       inline
       typename ::reflection::content::trinity::simple_struct<data_name, original_name, model_name, image_name, report_name >::typedef_type
       simple()
        {
         typedef ::reflection::content::trinity::simple_struct<data_name, original_name, model_name, image_name, report_name> simple_type;
