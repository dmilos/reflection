    ...
    namespace trinity
     {
       ...
       struct member_struct
        ...
        , public ::reflection::content::inspect::member_struct< data_name,image_name,class_name,storage_name >
        {
         public:
           ...
           typedef ::reflection::content::trinity::basic_class<data_name,original_type,image_name,model_name,storage_type,extractor_type, assigner_type, retriever_type, report_name  > typedef_type;
      ...
      template
       ...
       >
       inline
       typename ::reflection::content::trinity::member_struct<data_name,original_name, model_name, image_name,class_name,storage_name,report_name>::typedef_type
       member
        (
        ...
        {
         typedef ::reflection::content::trinity::member_struct<data_name,data_name const&,data_name const&,class_name,storage_name,report_name> member_type;
      ...
      template
       ...
       >
       inline
       typename ::reflection::content::trinity::member_struct<data_name,data_name&, data_name const&,data_name const&,class_name,storage_name,report_name>::typedef_type
       member
        (
          storage_name  const&             storage_param
        ...
        {
         typedef ::reflection::content::trinity::member_struct<data_name,data_name&, data_name const&,data_name const&,class_name,storage_name,report_name> member_type;
         return member_type::make( storage_param, traitor_param, writter_param, reader_param );
        }
