       ...
       struct member_struct
        ...
        , public ::reflection::content::inspect::member_struct< identifier_name, data_name,image_name,class_name,storage_name >
        {
         public:
           ...
           static typedef_type make( storage_type const& storage_param, writer_type const& writer_param, reader_type const& reader_param  )
            {
             return typedef_type( storage_param, assigner_type(writer_param), retriever_type(reader_param) );
            }
        };
      ...
      template
       ...
       member
        ...
        )
        {
         ...
         return member_type::make( storage_param, writer_param, reader_param );
        }
